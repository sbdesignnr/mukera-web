...
const sk = {
  ...
  reviews: {
    ...
    items: [
      ...
      "Oceňujem vysokoprofesionálny prístup pána doktora JUDr. Petra Múkeru ml. a zároveň príjemné prostredie tejto rodinnej advokátskej kancelárie.",
...
const en: Translation = {
  ...
  reviews: {
    ...
    items: [
      ...
      "I appreciate the highly professional approach of Dr. Peter Múkera Jr. and at the same time the pleasant environment of this family law firm.",
...
const de: Translation = {
  ...
  reviews: {
    ...
    items: [
      ...
      "Ich schätze den hochprofessionellen Umgang von Herrn Dr. Peter Múkera jun. sowie das angenehme Ambiente dieser familiären Anwaltskanzlei.",
...
const pl: Translation = {
  ...
  reviews: {
    ...
    items: [
      ...
      "Doceniam wysoce profesjonalne podejście pana doktora Petra Múkery jr. oraz miłą atmosferę tej rodzinnej kancelarii adwokackiej.",
